...
import net.mcreator.bluemoonworld.world.biome.MoonBiomeBiome;
...
public class BlueMoonWorldModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, BlueMoonWorldMod.MODID);
				...
				if (dimensionType == dimensionTypeRegistry.getOrThrow(DimensionType.OVERWORLD_LOCATION)) {
					...
					if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
						...
						if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
							...
							surfaceRules.add(1,
									preliminarySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, MOON_BIOME.getId()),
											BlueMoonWorldModBlocks.MOON_DEART.get().defaultBlockState(), Blocks.COBBLESTONE.defaultBlockState(),
